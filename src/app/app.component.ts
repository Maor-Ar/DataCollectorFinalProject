...
export class AppComponent implements OnInit, AfterContentInit {
  ...
  mouseMove($event: MouseEvent) {
    if (this.mouseMoveFlag == true) {
      ...
      this.mouseMoveTimeArray.push($event.timeStamp);
  ...
  scroll($event: Event)
  {  
    this.scrollTimeArray.push($event.timeStamp);
  }
  ...
  keyup($event: KeyboardEvent) {
    ...
    this.typeKeyBoardTimeArray.push($event.timeStamp);
  ...
  click($event: PointerEvent)
  {
    ...
    this.mouseClickTimeArray.push($event.timeStamp);
  }
  ...
  {
    console.log($event);
    this.touchSlideMatrix.push([$event.x,$event.y])
    this.touchSlideTimeArray.push($event.timeStamp);
  }
